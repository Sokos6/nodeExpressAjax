window.addEventListener("load", function () {
    ...
    var searchFieldHeader = document.getElementById("searchwordheader");
    ...
    searchField.addEventListener("keydown", arrowDown); // searchField "keydown"
    searchFieldHeader.addEventListener("keydown", arrowDown);

    var searchForWords = function (evt) {
        var actualField = evt.target;
        //var abbrev = searchField.value;
        var abbrev = actualField.value;
        if (abbrev.length < 1) {
            return;
        }
        var xhr = new XMLHttpRequest();
    ...
    searchField.addEventListener("keyup", searchForWords); // searchField "keyup"
    searchFieldHeader.addEventListener("keyup", searchForWords);
